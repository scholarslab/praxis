...
TODO: List outcomes
TODO: List skills
TODO: Move pedagogy stuff back
TODO: stretch out rest of fall
TODO: message shane about making codelab links clearer
TODO: Pull out outcomes more clearly Articulate units
TODO: Fit in ronda and laura's material
TODO: Need to fit in taken from week 3/4
...
* Week 1
  * Wednesday, August 24 from 10-11
    ...
    * Readings assigned
      * [Scholars’ Lab charter](https://.lib.virginia.edu/charter/)
      * [Scholars’ Lab student program charter](http://.org/student-programs-charter/)
      * [Praxis Program charter](http://praxis..org/charter/) - (overlaps a lot with the previous one, so I’d just look for the different bits)
...
* Week 2
  * Monday, August 29, from 10-11  
    * Conversation about Collaboration and Community, Brandon and others
    * Readings Assigned
      ...
      * Brandon and Amanda, [Building Community And Generosity In The Context Of Graduate Education](https://.lib.virginia.edu/blog/building-community-and-generosity-in-the-context-of-graduate-education/) - Also be sure to check out and peruse the three readings/tools linked in the "practices section"
  * Monday, August 29, from 11-12
    * Intro to Charters, Ronda 
    * Readings Assigned
      * Other Praxis cohort charters, available on the Praxis site - [http://praxis..org/charter/](http://praxis..org/charter/). Explore to your heart’s content, but they repeat each other a fair amount. So no need to go overboard - I might pick one or two.
      * And then, if you have time, you might check out one or two of the resources here - [http://praxis..org/resources/toward-a-project-charter/](http://praxis..org/resources/toward-a-project-charter/). Those are all related to charter development and very worthwhile. Explore at your interest, but the Collaborators’ Bill of Rights and Bethany’s piece are probably the most widely cited.
      ...
      * Praxis Alum Blog posts. Make sure you read them in order, as they respond to one another. There was also some discussion in the comments that got lost when we shifted platforms, but you'll get the idea. -
        * "[…but I don't like programming](https://.lib.virginia.edu/blog/but-i-dont-like-programming-gender-and-our-division-of-labor/)," Claire Maiers
        * "[Gendering Praxis](https://.lib.virginia.edu/blog/gendering-praxis/)," Cecilia Márquez
        * "[Gender and computing ctd](https://.lib.virginia.edu/blog/gender-and-computing-ctd/)," Shane Lin
  * Wednesday, August 29, from 10-11
...
* Week 4
  * Monday, September 12, from 10-11
    * Lightning Round of DH Methods and Disciplines. Round 1 - Texts (Alison), Archives (Jeremy), Makerspaces (Ammon);
  * Monday, September 12, from 11-12
      * Lightning Round 2 - Maps (Chris/Drew); Augmented Reality / CHI (Arin).VR / CHI (Will).
...
* Week 6
  ...
  * Monday, September 26,  11-12
    ...
    * Reading: Praxis blog posts:
      * [I need to write a blog post](https://.lib.virginia.edu/blog/I-need-to-write-a-blog-post/), Drew MacQueen
  ...
  * Monday, November 7,  10-11; 
    * Design jam workshop concepts 
      ...
      * Past outcomes for the unit might also be helpful for getting ideas (just pick what seems interesting to you - no need to read all of them):
        * "[To be out in the world, to be free](https://.lib.virginia.edu/blog/in-the-world/)!" Janet Dunkelbarger
        * "[String Theory, or: Let's Explore Social Networks with String](https://.lib.virginia.edu/blog/string-theory-or-lets-explore-social-networks-with-string/)," Chris Whitehead
        * "[Thinking about \[Art\] Collections as Data](https://.lib.virginia.edu/blog/art-collections-as-data/)", Chloe Downe Welles
        * "[Unmaking and Remaking the Archive](https://.lib.virginia.edu/blog/unmaking-remaking-archive/)", Natasha Roth-Rowland
        * "[Mapping Alone, Together](https://.lib.virginia.edu/blog/mapping-alone-together/)", Crystal Luo
        * "[Content Moderation Workshop](https://.lib.virginia.edu/blog/content-moderation-workshop/)", Grace Alvino
...
* Week 15
  * Monday, November 28,  10-11; 
    * Workshops due; 
    * Homework is to convert them into MarkDown: [Blogging documentation](https://github.com//.org/blob/master/docs/authoring-and-editing.md). ALso maybe start thinking about a first blog post introducing yourself and any thoughts you have in the early moments of the program!

  * Monday, November 28,  11-12; 
    * Workshops due discuss them.
  * Wednesday, December 1,  10-11; 
    * [Code lab](https://github.com//codelab)
* Week 16
  * Monday, December 5,  10-11; 
    * Timed writing prompts on teaching statements
      * could move that earlier piece here.
...
**Research and Administration in DH**

* 1 - Week of January 16; **No meeting on MLK day (January 16th)**
* 2 - Week of Jan 23;
* 3 - Week of Jan 30; Project Management workshop by Ronda  
* 4 - Week of Feb 6; Lauren Work on DH Project Sustainability 
* 5 - Week of Feb 13; Dave on grants
* 6 - Week of Feb 20; Brandon Butler on copyright and IP
* 7 - Week of Feb 27; Suitable team on Budgets and Management
* 8 - Week of March 6; **No meeting! Spring break**
* 9 - Week of March 13; Presentations by students on their interests and what's next for them
* 10 - Week of March 20; Presentations by students on their interests and what's next for them 
* 11 - Week of March 27; Presentations by students on their interests and what's next for them
* 12 - Week of April 3; Hackathon
* 13 - Week of April 10; Hackathon
* 14 - Week of April 17; Hackathon
* 15 - Week of April 28; Hackathon
* 16 - Week of May 1; Final Presentation Prep if needed and Career discussion
