...
* Week 5
  * Tuesday, September 22, 1-2
    * **TBD based on project** - maybe the disciplinary DH assignment
    * Readings Assigned
      * **TBD**
...
* Week 6
  * Tuesday, September 29, 1-2
    ...
    * Timed Writing Prompts on Digital Pedagogy
...
* Week 7
  * Tuesday, October 6, 1-2
    ...
    * Reading - "[Launching the Digital Humanities Movement at Washington and Lee University: A Case Study](http://academiccommons.org/blended-learning-2/launching-the-digital-humanities-movement-at-washington-and-lee-university-a-case-study/)"
  * Wednesday time TBD - Katina Rogers and Cihan Tekay talk on humanities PhD career development.
  * Thursday, October 8, 1-2
    * Discussion with Katina Rogers and Cihan Tekay from CUNY. **Booked**
    * Reading - check out Katina's **Putting the Humanities PhD to Word**
  * Thursday, October 8, 2-3
    * [Code lab](https://github.com/scholarslab/codelab)
* Week 8 (might be good for Yale - will hear back soon)
