...
* Week 2
  ...
  * Lightning Round of DH Methods and Disciplines. Round 1 - Texts (Alison **Accepted**), Archives (Jeremy **Requested**), Makerspaces (Ammon **Accepted**); 
* Week 3
  * Monday, September 6, 2021 from 1-2 
    * Lightning Round 2 - Maps (Chris/Drew **Accepted**); Augmented Reality / CHI (Arin **Requested**).VR / CHI (Will **Requested**). 
